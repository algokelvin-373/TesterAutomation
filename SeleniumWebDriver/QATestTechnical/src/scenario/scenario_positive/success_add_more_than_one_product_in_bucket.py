...
class SuccessAddMoreThanOneProductInBucket:
    ...
    def list_product_in_bucket(self):
        ...
        for index in range(self.__count_product):
            ...
            # element_store
            xpath_element = "//*[@id='__skipper']/div[2]/div/div/div[1]/div[1]/div[2]/div["+ str(index+1) +"]/div/div[2]/div/div[2]/div/div/div/div[1]/section[1]/span[1]"
    ...
    def delete_all_product_in_bucket(self):
        ...
        btn_delete_list_product = self.__driver.find_element(By.XPATH,
                                                             "//*[@id='__skipper']/div[2]/div/div/div[1]/div[1]/div[1]/div[2]/div/div/button")
