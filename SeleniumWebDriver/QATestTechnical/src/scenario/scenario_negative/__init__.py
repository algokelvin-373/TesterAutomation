from src.scenario.scenario_negative.failed_add_product_if_the_product_is_empty import \
    FailedAddProductIfTheProductIsEmpty
from src.scenario.scenario_negative.failed_checkout_if_the_product_in_bucket_is_empty import \
    FailedCheckoutIfTheProductInBucketIsEmpty
